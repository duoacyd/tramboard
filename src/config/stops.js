...
export const STOPS = [
  { stopId: "U1398Z2", name: "Mostecká",    direction: "", minMinutes: 2 },
  ...
  { stopId: "U1667Z2", name: "Tomanova",    direction: "", minMinutes: 2 },
  { stopId: "U1667Z1", name: "Tomanova",    direction: "", minMinutes: 2, lines: ["9", "7"], logo: "Lidl-Logo.svg.png" },
  { stopId: "U1211Z8", name: "Jugoslávská", direction: "", minMinutes: 2, lines: ["3"] },
];
