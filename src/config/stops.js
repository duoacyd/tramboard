...
export const STOPS = [
  { stopId: "U1398Z2", name: "Mostecká",    direction: "", minMinutes: 3, logo: "City-icon.png" },
  ...
  { stopId: "U1211Z8", name: "Jugoslávská", direction: "", minMinutes: 5, lines: ["3"], logo: "City-icon.png" },
];
